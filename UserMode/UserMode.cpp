...
void ReadWriteRegistry(uint32_t type, void* instruction) { //ndyjan1336 was here

	HKEY hKey = NULL;
	void* pointer = NULL;
	char Code[30] = "MyRegID";
	RegOpenKeyExA(HKEY_LOCAL_MACHINE, "\\Registry\\Machine\\SYSTEM\\ControlSet001\\Control", 0, KEY_ALL_ACCESS, &hKey);
